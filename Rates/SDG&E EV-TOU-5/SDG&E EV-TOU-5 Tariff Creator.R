...
# File Name: SDG&E EV-TOU-5 Tariff Creator.R
# File Location: "~/Desktop/SDG&E JARP/Rates/SDG&E EV-TOU-5"
# Project: San Diego JARP Supplementary Testimony
# Description: Creates SDG&E EV-TOU-5 retail rate for use in SDG&E JARP modeling.
...
SDGE_EV_TOU_5 <- data.frame(Date_Time = seq.POSIXt(Start_Date_Time, End_Date_Time, by = paste(Data_Timestep_Length, "min")))
...
SDGE_EV_TOU_5 <- SDGE_EV_TOU_5 %>%
  mutate(Total_Energy_Rate_EV_TOU_5 = (Summer_Peak_Binary * Summer_Peak_Energy_Rate) + 
